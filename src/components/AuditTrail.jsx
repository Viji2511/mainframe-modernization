...
const AuditTrail = ({ jobId, artifactId, onClearArtifact }) => {
  const api = useApi();
  ...
  return (
    <section className="bg-white border border-gray-200 rounded-lg shadow-sm p-3 space-y-3">
      ...
      {view === 'summary' && <div className="grid grid-cols-2 md:grid-cols-5 gap-2 font-mono text-xs">
      ...
      {view !== 'summary' && <>
        ...
        <div className="max-h-72 overflow-auto border rounded divide-y font-mono text-[11px]">
